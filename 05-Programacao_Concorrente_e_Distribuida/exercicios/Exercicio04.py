...
def sierpinski():
    ...
    plt.axis('off')
    plt.savefig(os.path.join(save_path, "sierpinski.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
def samambaia_barnsley():
    ...
    plt.axis('off')
    plt.savefig(os.path.join(save_path, "samambaia_barnsley.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
def mandelbrot(width=800, height=800, max_iter=100):
    ...
    plt.axis('off')
    plt.savefig(os.path.join(save_path, "mandelbrot.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
def julia(c=-0.7 + 0.27015j, width=800, height=800, max_iter=100):
    ...
    plt.axis('off')
    plt.savefig(os.path.join(save_path, "julia.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
def koch_curve(order=4, size=300):
    ...
    plt.axis('equal')
    plt.axis('off')
    plt.savefig(os.path.join(save_path, "koch_curve.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
def fractal_tree():
    ...
    plt.axis('equal')
    plt.axis('off')
    plt.savefig(os.path.join(save_path, "fractal_tree.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
def sierpinski_carpet(size=3, iterations=4):
    ...
    plt.axis('off')
    plt.savefig(os.path.join(save_path, "sierpinski_carpet.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
def menger_sponge(iterations=2):
    ...
    plt.savefig(os.path.join(save_path, "menger_sponge.png"), bbox_inches='tight', dpi=300)
    plt.close()
